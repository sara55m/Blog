...
class PostController extends Controller
{
    ...
    public function index(){
        ...
        return view("posts.index",[
            ...
            "posts"
            =>Post::latest()->filter(request(['search','category','author','tag']))->simplePaginate(6)->WithQueryString(),
            //=>PostTag::latest()->filter(request(['tag']))->simplePaginate(6)->WithQueryString(),
