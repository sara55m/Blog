                            ...
                            <div class="flex items-center text-sm">
                                ...
                                <div class="ml-3">
                                    <h5 class="font-bold"></h5>
                                        ...
                                        @if ($follower->blogger_id==$post->author->id && $follower->follower_id==$user->id)
                                        <h5>Following</h5>
                                        @else
                                        <form action="{{route('follow','author')}}" method='post'>
                                            @csrf
                                            <input type="hidden" name="follower" value="{{$user->id}}">
                                            <input type="hidden" name="blogger" value={{$post->author->id}}>
