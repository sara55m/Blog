    ...
    <section class="px-6 py-8">
        <main class="max-w-lg mx-auto mt-10 ">
            ...
            <x-panel>
                ...
                <form method="POST" action="/user/{{$author->id}}/update" class="mt-15" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="flex mt-6">
                        ...
                        <img src="/storage/{{$author->image}}" alt="" class="rounded-xl ml-6" width="100" height="120px">
                    </div>
