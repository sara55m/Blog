...
//user profile
Route::get("/user/{author->id}",[SessionController::class,'show']);
//edit form for user:
    Route::get("/user/{author}/edit",[SessionController::class,'edit']);
    //update
    Route::patch("/user/{author}/update",[SessionController::class,'update']);
