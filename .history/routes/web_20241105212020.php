...
//user profile
Route::get("/user/{author}",[RegisterController::class,'show']);
//edit form for user:
    Route::get("/user/{author}/edit",[RegisterController::class,'edit']);
    //update
    Route::patch("/user/{author}/update",[RegisterController::class,'update']);
    //delete user:
    Route::delete("/user/{author}/delete",[RegisterController::class,'destroy']);
...
Route::post('posts/{author}/follow',[FollowController::class,'toggleFollow'])->name('Follow');
